...
def make_prop(args, cfg, full_props_path):
    ...
    props.append("ro.build.fingerprint=google/redfin/redfin:11/RQ3A.211001.001/eng.electr.20230318.111310:user/release-keys")
    props.append("ro.system.build.description=redfin-user 11 RQ3A.211001.001 eng.electr.20230318.111310 release-keys")
    props.append("ro.bootimage.build.fingerprint=google/redfin/redfin:11/RQ3A.211001.001/eng.electr.20230318.111310:user/release-keys")
    props.append("ro.build.display.id=google/redfin/redfin:11/RQ3A.211001.001/eng.electr.20230318.111310:user/release-keys")
    props.append("ro.build.tags=release-keys")
    props.append("ro.build.description=redfin-user 11 RQ3A.211001.001 eng.electr.20230318.111310 release-keys")
    props.append("ro.vendor.build.fingerprint=google/redfin/redfin:11/RQ3A.211001.001/eng.electr.20230318.111310:user/release-keys")
