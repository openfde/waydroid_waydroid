...
def DBusInfraService(object_path="/InfraManager", intf="com.openfde.InfraManager"):
    return dbus.Interface(dbus.SystemBus().get_object("com.openfde.Infra", object_path), intf)
