...
def main():
    ...
    try:
        ...
        if args.action == "init":
            ...
            if args.subaction == "application":
                actions.notification.notify(args,"application")
            elif args.subaction == "desktop":
                actions.notification.notify(args,"desktop")
